...
jint Java_com_example_ocr_ReadFile_nativeReadMem(JNIEnv *env, jclass clazz,
...
jint Java_com_example_ocr_ReadFile_nativeReadBytes8(JNIEnv *env, jclass clazz,
...
jboolean Java_com_example_ocr_ReadFile_nativeReplaceBytes8(JNIEnv *env,
                                                                            jclass clazz,
                                                                            jint nativePix,
                                                                            jbyteArray data,
                                                                            jint srcw, jint srch) {
...
jint Java_com_example_ocr_ReadFile_nativeReadFiles(JNIEnv *env, jclass clazz,
...
jint Java_com_example_ocr_ReadFile_nativeReadFile(JNIEnv *env, jclass clazz,
                                                                   jstring fileName) {
  PIX *pixd = NULL;
...
jint Java_com_example_ocr_ReadFile_nativeReadBitmap(JNIEnv *env, jclass clazz,
                                                                     jobject bitmap) {
  l_int32 w, h, d;
