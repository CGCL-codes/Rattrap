...
jint Java_com_example_ocr_Pixa_nativeCreate(JNIEnv *env, jclass clazz, jint size) {
  PIXA *pixa = pixaCreate((l_int32) size);

  return (jint) pixa;
}

jint Java_com_example_ocr_Pixa_nativeCopy(JNIEnv *env, jclass clazz,
                                                           jint nativePixa) {
...
jint Java_com_example_ocr_Pixa_nativeSort(JNIEnv *env, jclass clazz,
...
void Java_com_example_ocr_Pixa_nativeDestroy(JNIEnv *env, jclass clazz,
                                                              jint nativePixa) {
...
jint Java_com_example_ocr_Pixa_nativeGetCount(JNIEnv *env, jclass clazz,
                                                               jint nativePixa) {
  PIXA *pixa = (PIXA *) nativePixa;
...
void Java_com_example_ocr_Pixa_nativeAddPix(JNIEnv *env, jclass clazz,
...
void Java_com_example_ocr_Pixa_nativeAdd(JNIEnv *env, jclass clazz,
                                                          jint nativePixa, jint nativePix,
...
void Java_com_example_ocr_Pixa_nativeReplacePix(JNIEnv *env, jclass clazz,
...
jint Java_com_example_ocr_Pixa_nativeGetPix(JNIEnv *env, jclass clazz,
                                                             jint nativePixa, jint index) {
  PIXA *pixa = (PIXA *) nativePixa;
...
jboolean Java_com_example_ocr_Pixa_nativeGetBoxGeometry(JNIEnv *env, jclass clazz,
                                                                         jint nativePixa,
                                                                         jint index,
