...
jint Java_com_example_ocr_AdaptiveMap_nativeBackgroundNormMorph(JNIEnv *env,
                                                                                 jclass clazz,
                                                                                 jint nativePix,
                                                                                 jint reduction,
                                                                                 jint size,
...
jint Java_com_example_ocr_Binarize_nativeOtsuAdaptiveThreshold(JNIEnv *env,
                                                                                jclass clazz,
                                                                                jint nativePix,
                                                                                jint sizeX,
                                                                                jint sizeY,
...
jint Java_com_example_ocr_Convert_nativeConvertTo8(JNIEnv *env, jclass clazz,
                                                                    jint nativePix) {
  PIX *pixs = (PIX *) nativePix;
...
jint Java_com_example_ocr_Enhance_nativeUnsharpMasking(JNIEnv *env, jclass clazz,
                                                                        jint nativePix,
                                                                        jint halfwidth,
                                                                        jfloat fract) {
  PIX *pixs = (PIX *) nativePix;
...
jbyteArray Java_com_example_ocr_JpegIO_nativeCompressToJpeg(JNIEnv *env,
                                                                             jclass clazz,
                                                                             jint nativePix,
                                                                             jint quality,
...
jint Java_com_example_ocr_Scale_nativeScale(JNIEnv *env, jclass clazz,
...
jfloat Java_com_example_ocr_Skew_nativeFindSkew(JNIEnv *env, jclass clazz,
...
jint Java_com_example_ocr_Rotate_nativeRotate(JNIEnv *env, jclass clazz,
