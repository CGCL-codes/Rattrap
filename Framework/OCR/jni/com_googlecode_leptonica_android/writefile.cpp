...
jint Java_com_example_ocr_WriteFile_nativeWriteBytes8(JNIEnv *env, jclass clazz,
                                                                       jint nativePix,
                                                                       jbyteArray data) {
  l_int32 w, h, d;
...
jboolean Java_com_example_ocr_WriteFile_nativeWriteFiles(JNIEnv *env,
                                                                          jclass clazz,
                                                                          jint nativePixa,
                                                                          jstring rootName,
                                                                          jint format) {
...
jbyteArray Java_com_example_ocr_WriteFile_nativeWriteMem(JNIEnv *env,
                                                                          jclass clazz,
                                                                          jint nativePix,
                                                                          jint format) {
...
jboolean Java_com_example_ocr_WriteFile_nativeWriteImpliedFormat(
                                                                                  JNIEnv *env,
                                                                                  jclass clazz,
                                                                                  jint nativePix,
                                                                                  jstring fileName,
...
jboolean Java_com_example_ocr_WriteFile_nativeWriteBitmap(JNIEnv *env,
                                                                           jclass clazz,
                                                                           jint nativePix,
                                                                           jobject bitmap) {
  PIX *pixs = (PIX *) nativePix;
