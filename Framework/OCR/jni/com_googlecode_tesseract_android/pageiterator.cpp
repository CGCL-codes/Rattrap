...
void Java_com_example_ocr_PageIterator_nativeBegin(JNIEnv *env, jclass clazz,
    jint nativePageIterator) {
  ((PageIterator *) nativePageIterator)->Begin();
}

jboolean Java_com_example_ocr_PageIterator_nativeNext(JNIEnv *env, jclass clazz,
