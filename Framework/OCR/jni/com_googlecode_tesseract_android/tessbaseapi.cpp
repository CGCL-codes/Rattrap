...
void Java_com_example_ocr_TessBaseAPI_nativeClassInit(JNIEnv* env, jclass clazz) {
  field_mNativeData = env->GetFieldID(clazz, "mNativeData", "I");
}

void Java_com_example_ocr_TessBaseAPI_nativeConstruct(JNIEnv* env,
    jobject object) {
...
void Java_com_example_ocr_TessBaseAPI_nativeFinalize(JNIEnv* env, jobject object) {
...
jboolean Java_com_example_ocr_TessBaseAPI_nativeInit(JNIEnv *env, jobject thiz,
...
void Java_com_example_ocr_TessBaseAPI_nativeSetImageBytes(JNIEnv *env,
...
void Java_com_example_ocr_TessBaseAPI_nativeSetImagePix(JNIEnv *env, jobject thiz,
    jint nativePix) {
...
void Java_com_example_ocr_TessBaseAPI_nativeSetRectangle(JNIEnv *env, jobject thiz,
...
jstring Java_com_example_ocr_TessBaseAPI_nativeGetUTF8Text(JNIEnv *env,
    jobject thiz) {
  native_data_t *nat = get_native_data(env, thiz);
...
jint Java_com_example_ocr_TessBaseAPI_nativeGetRegions(JNIEnv *env, jobject thiz) {
  native_data_t *nat = get_native_data(env, thiz);
  Pixa *pixa;
...
jint Java_com_example_ocr_TessBaseAPI_nativeGetWords(JNIEnv *env, jobject thiz) {
  native_data_t *nat = get_native_data(env, thiz);
  Pixa *pixa;
...
void Java_com_example_ocr_TessBaseAPI_nativeStop(JNIEnv *env, jobject thiz) {
  native_data_t *nat = get_native_data(env, thiz);

  // TODO How do we stop without a monitor?!
}

jint Java_com_example_ocr_TessBaseAPI_nativeMeanConfidence(JNIEnv *env,
    jobject thiz) {
  native_data_t *nat = get_native_data(env, thiz);
...
jintArray Java_com_example_ocr_TessBaseAPI_nativeWordConfidences(JNIEnv *env,
    jobject thiz) {
  native_data_t *nat = get_native_data(env, thiz);
...
jboolean Java_com_example_ocr_TessBaseAPI_nativeSetVariable(JNIEnv *env,
...
void Java_com_example_ocr_TessBaseAPI_nativeClear(JNIEnv *env, jobject thiz) {
  native_data_t *nat = get_native_data(env, thiz);
...
void Java_com_example_ocr_TessBaseAPI_nativeEnd(JNIEnv *env, jobject thiz) {
  native_data_t *nat = get_native_data(env, thiz);
...
void Java_com_example_ocr_TessBaseAPI_nativeSetDebug(JNIEnv *env, jobject thiz,
    jboolean debug) {
  native_data_t *nat = get_native_data(env, thiz);
...
void Java_com_example_ocr_TessBaseAPI_nativeSetPageSegMode(JNIEnv *env,
...
jint Java_com_example_ocr_TessBaseAPI_nativeGetResultIterator(JNIEnv *env,
    jobject thiz) {
  native_data_t *nat = get_native_data(env, thiz);
